...
if [[ "$ans" != "0" ]];
then
    echo "No, Variable have scope and each scope (a {} section) can have his own variable name (here we have two "j" one for the for loop and one for the rest of the code. One does not impact the other. Please compile and run test_1.c to see it in action"
    false
else
